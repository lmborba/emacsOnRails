...
(defun rspec-verify ()
  ...
  (interactive)
  (rspec-run-cmd (concat "cd " (rspec-parent-directory (rspec-spec-directory (buffer-file-name))) " && bundle exec rspec " (rspec-spec-file-for (buffer-file-name)))))
...
(defun rspec-verify-all ()
  ...
  (interactive)
  (rspec-run-cmd (concat "cd " (rspec-parent-directory (rspec-spec-directory (buffer-file-name))) " && bundle exec rspec spec")))
